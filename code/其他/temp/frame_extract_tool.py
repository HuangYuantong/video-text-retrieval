...
def extract_all_videos(frameExtractor, inputs: Union[str, list[str]], output_path: str, key_frames_data_path: str):
    ...
    update_key_frames_data(video_ids, key_frame_counts, key_frames_data_path)


def update_key_frames_data(video_ids: list[int], key_frame_counts: Union[list[int], numpy.ndarray], key_frames_data_path: str):
